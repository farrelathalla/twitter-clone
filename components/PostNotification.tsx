import { PostNotifProps } from "@/lib/types";
...
const PostNotification: React.FC<PostNotifProps> = ({
  profileImage,
  username,
  fullname,
  reply,
        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-2 items-center">
              <p className="text-sm text-grey_disable">Replying to</p>
              <p className="hover:underline text-blue_twitter cursor-pointer mb-[3px]">
                @{reply}
              </p>
            </div>
            <p> {content} </p>
